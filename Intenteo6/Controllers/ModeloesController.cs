...
namespace Intenteo6.Controllers
{
    public class ModeloesController : Controller
    {
        ...
        public ModeloesController(DriveDreamDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdModelo,Descripcion")] Modelo modelo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdModelo,Descripcion")] Modelo modelo)
        {
