...
namespace Intenteo6.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public GeneroesController(DriveDreamDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdGenero,Genero1")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdGenero,Genero1")] Genero genero)
        {
